...
<div class="row">
    ...
    <div class="container">
        ...
        <div class="function">
            <span>
                <a href="<%=request.getContextPath()%>/product-create.jsp" class="btn btn-success mb-3 mr-3 mt-2" role="button">
                    Add New Products</a>
            </span>
            <form action="/product" id="f">
                <input type="hidden" name="action" value="sort">
<%--                <a href="<%=request.getContextPath()%>/product-list.jsp" class="btn btn-primary mb-2 mt-2" role="button">Sort Products</a>--%>
...
<%--                        <a href="delete?id=<c:out value='${product.id}' />">Delete</a></td>--%>
                            <button type="button" class="btn btn-warning">
                                <a class="btn__edit" href="/product?action=edit&id=<c:out value='${product.id}' />">Edit</a>
                            </button>
                            <button onclick="deleteProductModal(${product.id}, '${product.name}')" type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal">
                                Delete
                            </button></td>
                </tr>
            </c:forEach>
    ...
    <script>
        function deleteProductModal(id, name) {
